...
final class InjectNode: Codable, Node {
  ...
  required init(from decoder: any Decoder) throws {
    ...
    if _repeat.isEmpty {
      ...
      throw DecodingError.dataCorruptedError(
        forKey: .repeat, in: container, debugDescription: "Expected a Double value for repeat")
    }
  ...
  private enum CodingKeys: String, CodingKey {  // Coding keys for decoding
    case id, type, z, name, props, `repeat`, crontab, once, onceDelay, topic, payload, payloadType,
      x, y, wires
  }
